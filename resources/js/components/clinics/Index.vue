        ...
        <div class="block-content">
            <table class="table table-striped table-vcenter">
                ...
                <tr v-for="clinic in clinics">
                    <th class="text-center" scope="row" v-html="clinic.id">1</th>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            <a :href="'/clinics/' + clinic.id + '/edit'" class="btn btn-sm btn-primary js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Edit">
